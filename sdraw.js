...
var bgrect, body, candsearch, clickedElement, clickfunc, clone, deletestate, downpoint, downtime, drawPath, draw_mode, duplicated, edit_mode, elementpath, elements, fontsize, hideframe, linecolor, lines, linewidth, mode, modetimeout, moved, movepoint, movetime, moving, path, pen, points, polygon, polyline, randomTimeout, recognition, recogstrokes, resettimeout, resize, selected, selfunc, setTemplate, setfunc, shakepoint, showframe, sizeframe, sizesquare, snapdx, snapdy, strokes, svg, timeseed, totaldist, uppoint, uptime, zooming, zoomorigx, zoomorigy, zoomx, zoomy,
...
edit_mode = function() {
  ...
  svg.on('mousemove', function() {
    var d, dd, movex, movey, mpoints, newelements, oldmovepoint, point, refpoint, refpoints, scalex, scaley, snappoint, _j, _k, _l, _len1, _len2, _len3, _len4, _len5, _len6, _len7, _len8, _len9, _m, _n, _o, _p, _q, _r, _ref, _ref1;
    if (!downpoint) {
      return;
    }
  ...
  return svg.on('mouseup', function() {
    var f, scalex, scaley, upoints, _j, _k, _l, _len1, _len2, _len3;
    if (!downpoint) {
      return;
    }
    d3.event.preventDefault();
