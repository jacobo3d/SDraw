...
var bgrect, body, candsearch, clickedelement, clone, downpoint, downtime, draw, draw_mode, edit_mode, elements, mode, modetimeout, moved, moving, path, points, randomTimeout, recognition, resettimeout, resize, selected, selfunc, setTemplate, setfunc, strokes, svg, timeseed,
...
clone = function(dx, dy) {
  var attr, ccloned, cloned, e, element, newselected, node_name, parent, x, y, _i, _j, _len, _len1;
  newselected = [];
