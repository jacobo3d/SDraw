...
var body, candsearch, copied_element, downpoint, draw, draw_mode, edit_mode, elementx, elementy, imageheight, imagewidth, mode, mousedown, move_mode, path, points, pointx, pointy, randomTimeout, recognition, resize, selected, selfunc, setTemplate, strokes, svg, timeseed;
...
recognition = function() {
  ...
  return [0, 1, 2, 3, 4, 5].forEach(function(i) {
    ...
    candelement.on('mousedown', function() {
      var attr, target, _len4, _p, _ref3, _ref4;
      d3.event.preventDefault();
      mousedown = true;
      _ref3 = d3.mouse(this), pointx = _ref3[0], pointy = _ref3[1];
      strokes = [];
      target = d3.event.target;
      copied_element = svg.append(target.nodeName);
      _ref4 = target.attributes;
      for (_p = 0, _len4 = _ref4.length; _p < _len4; _p++) {
        attr = _ref4[_p];
    ...
    candelement.on('mousemove', function() {
      ...
      return copied_element.attr("transform", "translate(" + (x - pointx) + "," + (y - pointy) + ")");
    });
