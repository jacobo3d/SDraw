...
var bgrect, body, candsearch, clickedElement, clone, debug, deletestate, downpoint, downtime, drawPath, draw_mode, duplicated, edit_mode, elements, fontsize, linecolor, linewidth, mode, modetimeout, moved, movepoint, moving, path, points, randomTimeout, recognition, recogstrokes, resettimeout, resize, selected, selfunc, setTemplate, setfunc, shakepoint, snapdx, snapdy, strokes, svg, timeseed, totaldist, uppoint,
  ...
  svg.on('mousemove', function() {
    ...
    if (totaldist > 200) {
      ...
      for (_n = 0, _len5 = points.length; _n < _len5; _n++) {
        point = points[_n];
        for (_o = 0, _len6 = refpoints.length; _o < _len6; _o++) {
          refpoint = refpoints[_o];
    ...
    _results = [];
    for (_p = 0, _len7 = selected.length; _p < _len7; _p++) {
      element = selected[_p];
